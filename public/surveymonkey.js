    ...
    function logDocumentWriteError(e) {
      ...
      log("document.write failed, aborting");
        ...
        if (window.screen.availWidth < 360) {
          customHeight += (360 - window.screen.availWidth) * 10;
        };
        customHeight = String(customHeight) + 'px';
        smcxParams = {
          env: 'prod',
          debug: false,
